...
1. [`architecture.md`](./architecture.md) — plain-English names, directory map, runtime topology.
2. [`contracts.md`](./contracts.md) — reader-friendly contract names, public type surface, ownership rules, change protocol.
